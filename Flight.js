...
view.on("click", (event) => {
    ...
    addCustomButtons(flightPlanExtent);

    function zoomToFlightPlan(extent) {
    if (extent) {
...
function addCustomButtons(flightPlanExtent) {
    ...
    // Zoom to Flight Plan button
    const zoomButton = document.createElement("button");
    zoomButton.innerText = "Zoom to Flight Plan";
    zoomButton.style.padding = "8px";
    zoomButton.style.background = "#007BFF";
    zoomButton.style.color = "#fff";
    zoomButton.style.border = "none";
    zoomButton.style.borderRadius = "4px";
    zoomButton.style.cursor = "pointer";
    zoomButton.onclick = () => zoomToFlightPlan(flightPlanExtent);
    buttonContainer.appendChild(zoomButton);

    // Recenter to User button
    const recenterButton = document.createElement("button");
    recenterButton.innerText = "Recenter to My Location";
    recenterButton.style.padding = "8px";
    recenterButton.style.background = "#28A745";
    recenterButton.style.color = "#fff";
